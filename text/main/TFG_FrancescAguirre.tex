...
\captionof{figure}{Exemple genèric d'hiperparàmetre C en models SVC, de la famosa base de dades \textit{Iris} \cite[Cap. 5]{geron2019hands}. La imatge no aporta cap valor al problema EMNIST.}
\label{fig:svc_exp}
\end{figure}
