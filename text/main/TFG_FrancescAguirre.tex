...
Quan es treballa amb imatges, és difícil extreure idees de les variables explicatives, perquè són molts píxels en diferents intensitats. Per fer-se una idea de quines imatges ens podem trobar, pot ajudar visualitzar alguns exemples de la base de dades (fig:\ref{fig:sample_random}).
